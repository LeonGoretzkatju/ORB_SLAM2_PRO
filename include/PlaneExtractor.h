//
// Created by deeprealtech on 2022/3/30.
//

#ifndef ORB_SLAM2_PLANEEXTRACTOR_H
#define ORB_SLAM2_PLANEEXTRACTOR_H
...
public:
    ...
    cv::Mat runPlaneDetection(const cv::Mat &depthImg, const cv::Mat &RGBImg);

};

#endif //ORB_SLAM2_PLANEEXTRACTOR_H
